...
@Entity
@Table(name = "external_apartment_register_head")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ApartmentRegisterHead {
...
//    private String mgmBldrgstPk;
    ...
    @Comment("지붕코드")
    @Column(name = "roof_cd", length = 10)
    private String roofCd;

    @Comment("지붕코드명")
    @Column(name = "roof_cd_nm", length = 50)
    private String roofCdNm;

    @Comment("기타지붕")
    @Column(name = "etc_roof", length = 200)
    ...
    @Comment("높이(m)")
    @Column(name = "heit", length = 20)
    private String heit;

    @Comment("지상층수")
    @Column(name = "grnd_flr_cnt", length = 10)
    private String grndFlrCnt;

    @Comment("지하층수")
    @Column(name = "ugrnd_flr_cnt", length = 10)
    private String ugrndFlrCnt;

    @Comment("승용승강기수")
    @Column(name = "ride_use_elvt_cnt", length = 10)
    private String rideUseElvtCnt;

    @Comment("비상용승강기수")
    @Column(name = "emgen_use_elvt_cnt", length = 10)
    ...
    @Comment("총동연면적(㎡)")
    @Column(name = "tot_dong_tot_area", length = 20)
    ...
    @Comment("내진설계적용여부")
    @Column(name = "rserthqk_dsgn_apply_yn", length = 1)
    private String rserthqkDsgnApplyYn;

    @Comment("내진능력")
    @Column(name = "rserthqk_ablty", length = 20)
