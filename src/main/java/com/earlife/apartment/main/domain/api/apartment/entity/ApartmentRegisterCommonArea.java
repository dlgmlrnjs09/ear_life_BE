...
@Entity
@Table(name = "external_apartment_register_common_area")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ApartmentRegisterCommonArea {
...
//    private String mgmBldrgstPk;
    ...
    @Comment("전유공용구분코드")
    @Column(name = "expos_pubuse_gb_cd", length = 10)
    private String exposPubuseGbCd;

    @Comment("전유공용구분코드명")
    @Column(name = "expos_pubuse_gb_cd_nm", length = 50)
